      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            <DialogTitle
              as="h3"
              className="text-lg font-medium text-center leading-6 text-gray-900 py-3"
            >
              Enter your details to join the camp
            </DialogTitle>
            <div className="mt-2">
            ...
            <div className="mt-1">
              ...
              <button
                onClick={payLater}
                className="w-full  mt-5 bg-[#006D77] text-white py-2 font-medium"
              >
                {" "}
