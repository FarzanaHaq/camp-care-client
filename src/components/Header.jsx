      ...
      <div className="navbar bg-base-100 pt-2 roboto-new w-[340px] lg:w-6xl rounded-full">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl ">
            <div className="hidden lg:flex items-center gap-2">
              <img
                className="w-15 h-15 bg-white mt-1 rounded-full"
        ...
        <div className="navbar-end lg:pr-5 gap-2">
          <div className="relative">
            ...
            {isOpen && (
              <div className="absolute rounded-xl shadow-md w-[180px] bg-white overflow-hidden right-5 top-10s text-sm z-10">
          ...
          <label className="swap swap-rotate hidden lg:inline-flex -ml-0 border-1 border-gray-300 rounded-full p-0.5">
