  ...
  return (
    <div>
      <div className=" ">
        ...
        ></TitleCard>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mt-10 mb-10 lg:mb-20 px-5">
          {data.length > 0
            ...
            : <h1 className="text-center text-[16px] font-[600]">Data fetching failed. Try again later</h1>}
        </div>
