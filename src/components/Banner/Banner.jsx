...
const Banner = () => {
  ...
  return (
    <div className="bg-[#F2F4F7] h-[2080px] back-primary ">
      <div class="relative  bg-[linear-gradient(to_bottom,#83848633,#102634),url('https://i.ibb.co.com/zHCtVFLq/2148973496.jpg')] bg-cover bg-center mb-80">
        <div class="relative z-10 flex items-center justify-center h-full pt-5 pb-100">
          <div>
            <Header></Header>
            <div className="text-white flex justify-center items-center mt-25 gap-3 letter-primary">
              <FaHeartPulse></FaHeartPulse>
              <h1 className="font-[500] mt-0.5 text-[18px] uppercase">
                Welcome to campcare
              </h1>
            </div>
            <p className="text-[60px] font-[700] text-white letter-primary text-center mt-5 leading-18">
              Exceptional Health Treatment <br /> Always Find Here
            </p>
            <p className="text-[20px] font-[500] text-white letter-primary text-center mt-5 leading-8">
      ...
      <div className="bg-[#006D77] back-card w-6xl mx-auto p-15 rounded-2xl absolute top-200 left-25">
        <h1 className="text-white text-[40px] font-[600] leading-12 letter-primary">
          Redefining Medical <br /> Camps with Humanity
        </h1>
        <p className="text-white text-[16px] font-[500] my-5 letter-sec">
      ...
      <div className="absolute top-175 right-40">
        <div className="w-[500px] mx-auto px-13 py-10 bg-white back-card rounded-xl shadow-2xl">
          <h2 className="text-[30px] font-[600] mb-4 text-gray-800 letter-primary">
            Get Started Today
          </h2>
