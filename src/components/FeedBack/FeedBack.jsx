...
export const FeedBack = () => {
  ...
  return (
    <div className="mt-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-center text-3xl font-bold text-sky-400 mb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {data.map((item) => (
          ...
          >
            ...
            <p className="text-gray-700 mb-4 italic border-l-4 border-sky-300 pl-3">
              "{item.comment}"
            </p>
            ...
            <div className="flex items-center gap-1">
              {[1, 2, 3, 4, 5].map((star) => (
                <svg
                  ...
                  fill={star <= item.rating ? "#38bdf8" : "none"}
                  viewBox="0 0 24 24"
                  stroke="#38bdf8"
                  strokeWidth="2"
                  className="w-5 h-5"
