...
const Banner = () => {
  ...
  return (
    <div className="bg-[#F2F4F7]">
      <div className="relative bg-[linear-gradient(to_bottom,#83848633,#102634),url('https://i.ibb.co.com/zHCtVFLq/2148973496.jpg')] bg-cover bg-center mb-5 lg:mb-80 pb-10 lg:pb-100">
