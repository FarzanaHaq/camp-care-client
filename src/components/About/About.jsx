...
export const About = () => {
  return (
    <div className="lg:mt-20 relative px-5">
        ...
        <div className=" flex justify-start items-center gap-3 text-[#006D77] letter-primary">
          ...
          <h1 className="font-[500] mt-0.5 text-[14px] lg:text-[18px] uppercase">About Us</h1>
        </div>
        ...
        <p className="text-[15px] lg:text-[18px] text-[#6F6F6F] max-w-[400px]">
          ...
          encompassing a  range of services from preventive care to
          treatment
        </p>
        <div className="mt-5">
      ...
      <div className="bg-white back-card lg:w-[450px] p-5 lg:py-10 lg:px-10 rounded-2xl space-y-5 shadow-xl lg:absolute lg:right-10 lg:top-12">
        ...
        <div className="flex justify-between items-center border-2 border-gray-200 py-3 px-5 rounded-2xl">
          ...
          <p className="text-[16px] lg:text-[20px] font-[600] text-[#031B4E]">9 Am To 5 Pm</p>
        </div>
        <div className="flex justify-between items-center border-2 border-gray-200 py-3 px-5 rounded-2xl">
          <p className="text-[17px] font-[500]  text-[#6F6F6F]">
            Monday-Tuesday
