...
export const FeedBack = () => {
  ...
  return (
    <div className="bg-[#F2F4F7] py-0 lg:py-5 mt-5 back-primary">
      <TitleCard
        intro=" Client Review's"
        title=" What Our Clients Say"
        description="Real stories from real patients to discover how our service has
          helped countless people with affordable healthcare."
      ></TitleCard>
        ...
        >
          {data.map((item) => (
            <SwiperSlide>
              <div
                key={item._id}
                className="bg-white back-card rounded-2xl shadow-lg p-6 border border-sky-100 hover:shadow-xl transition duration-300 mt-15 mb-15 md:h-[200px] mx-2"
              >
                ...
                <p className="text-gray-700 mb-4 italic border-l-4 border-[#006D77] pl-3 mt-4">
                  "{item.comment}"
                </p>
